...
func (o *UpdateTopLevelModeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateTopLevelModeOK()
...
func (o *UpdateTopLevelModeOK) Error() string {
	return fmt.Sprintf("[PUT /mode][%d] updateTopLevelModeOK  %+v", 200, o.Payload)
}

func (o *UpdateTopLevelModeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.ModeUpdateRequest)
